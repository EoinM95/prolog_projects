...
test(16) :- s(X,[sal,suggested,val,hated,a,cat]).%yes %broke
...
test(22) :- s(X,[sal,suggested,val]). %yes %broke
...
test(b26) :- s(X,[teri, believed, lee, an, ass]).%Inconsistent, 18 is passing
...
test(de25) :- s(X,[teri, denied, lee, hated, pharmacology]).%yes
test(de26) :- s(X,[teri, denied, lee, an, ass]).%yes
test(de27) :- s(X,[teri, denied, val]). %false
test(de28) :- s(X,[teri, denied, val, to, hate, coffee]). %false
test(de29) :- s(X,[teri, denied, that, lee, hated, pharmacology]).%yes
test(de30) :- s(X,[teri, denied, whether, lee, hated, pharmacology]).%false
test(de31) :- s(X,[teri, denied, who, hated, pharmacology]).%false

test(do25) :- s(X,[teri, doubted, lee, hated, pharmacology]).%true
test(do26) :- s(X,[teri, doubted, lee, an, ass]).%false
test(do27) :- s(X,[teri, doubted, val]).%true
test(do28) :- s(X,[teri, doubted, val, to, hate, coffee]).%true
test(do29) :- s(X,[teri, doubted, that, lee, hated, pharmacology]).%true
test(do30) :- s(X,[teri, doubted, whether, lee, hated, pharmacology]).%true
test(do31) :- s(X,[teri, doubted, who, hated, pharmacology]).%false

test(h25) :- s(X,[teri, hated, lee, hated, pharmacology]).
test(h26) :- s(X,[teri, hated, lee, an, ass]).
test(h27) :- s(X,[teri, hated, val]).
test(h28) :- s(X,[teri, hated, val, to, hate, coffee]).%true
test(h29) :- s(X,[teri, hated, that, lee, hated, pharmacology]).%true
...
test(k29) :- s(X,[teri, knew, that, lee, hated, pharmacology]).%true
test(k30) :- s(X,[teri, knew, whether, lee, hated, pharmacology]).%true
test(k31) :- s(X,[teri, knew, who, hated, pharmacology]).%true

test(l25) :- s(X,[teri, liked, lee, hated, pharmacology]).
test(l26) :- s(X,[teri, liked, lee, an, ass]).
test(l27) :- s(X,[teri, liked, val]).
test(l28) :- s(X,[teri, liked, val, to, hate, coffee]).%true
test(l29) :- s(X,[teri, liked, that, lee, hated, pharmacology]).%true
...
test(per27) :- s(X,[teri, persuaded, val]).%true
test(per28) :- s(X,[teri, persuaded, val, to, hate, coffee]).%true
...
test(pro26) :- s(X,[teri, proved, lee, an, ass]).%true
test(pro27) :- s(X,[teri, proved, val]).
test(pro28) :- s(X,[teri, proved, val, to, hate, coffee]).%true
test(pro29) :- s(X,[teri, proved, that, lee, hated, pharmacology]).
test(pro30) :- s(X,[teri, proved, whether, lee, hated, pharmacology]).%true
...
test(su28) :- s(X,[teri, suggested, val, to, hate, coffee]).%should def be false
...
good([a27,a28,a30,a31,b25,b26,b27,b28,b29,de25,de26,de29,do25,do27,do28,do29,h27,h28,h29,k25,k27,k28,k29,k30,k31,l27,l28,l29,per27,per28,pro25,pro26,pro28,pro29,pro30,q27,q30,q31,ref27,ref29,reg25,reg28,reg29,sa25,sa29,sa30,sa31,su25,su27,su29,su30,su31,t25,t26,t28,t29,v25,v29,v30,v31,wa27,wa28,won30,won31]).
%removed su28 from pass, should it pass if 25 fails?
%Should 18 pass if b26 should fail? Added b26 to pass
