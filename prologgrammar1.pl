...
word(vt,[liked],[np],[np],fin).
word(vt,[ask],[np],[np],bse).
word(vt,[asked],[np],[np],fin).
...
word(vt,[knew],[np],[s(fin),s(comp),s(inf)],fin).
word(vt,[knew],[np],[np],fin).
word(vt,[thought],[np],[s(fin),s(comp),s(nv),s(inf)],fin).
word(vt,[believed],[np],[s(fin),s(nv),s(inf),vcompclause(fin)],fin).
word(vt,[believed],[np],[np],fin).
word(vt,[denied],[np],[s(fin),s(nv),s(inf),vcompclause(fin)],fin)
word(vt,[suggested],[np],[np,s(fin)],fin).
